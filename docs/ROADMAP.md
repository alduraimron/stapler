...
| R5 | Integrasi **ADR**: field "ADR terkait" di plan + langkah update status ADR di `implement-task` | Di project yang memakai ADR, keputusan sesi master perlu terekam dan statusnya ditutup saat implementasi | S | Belum |
